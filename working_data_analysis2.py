...
my_dataframe.unexeserv = my_dataframe.description.apply(lambda x: "!UNEXE  RETURN" in x)
...
unexeserv_count = len(my_dataframe[my_dataframe.unexeserv ==1])
...
unexeserv_ppl_count = len(set(my_dataframe[my_dataframe.unexeserv == 1].ncp))
...
unexeserv_id_count = len(set(my_dataframe[my_dataframe.unexeserv == 1].id))
...
my_dataframe['unexe serv'] = my_dataframe.description.apply(lambda x: "1" if "!UNEXE RETURN" in x else "0")
my_dataframe['garnish'] = my_dataframe.description.apply(lambda x: "1" if "WRIT WITH" in x else "0")
...
my_dataframe.to_csv("my_dataframe_working2.csv")
#convert to csv
my_dataframe.to_csv("my_dataframe_working2.csv", index=False)
